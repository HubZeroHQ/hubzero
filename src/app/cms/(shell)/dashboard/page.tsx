...
import { ContentEntryList } from '@/components/cms/dashboard/ContentEntryList';
import { DashboardWidgetCard } from '@/components/cms/dashboard/DashboardWidgetCard';
import { NewLeadsWidget } from '@/components/cms/dashboard/NewLeadsWidget';
import { RecentActivityWidget } from '@/components/cms/dashboard/RecentActivityWidget';
import { PageHeader } from '@/components/cms/PageHeader';
import { auth } from '@/lib/auth';
import { listAllContent } from '@/lib/cms/dashboard-queries';
import { leadRepository } from '@/lib/db/repositories/lead';

export const metadata: Metadata = {
  title: 'Dashboard — HubZero CMS',
};
 ...
 * only because no CMS content exists yet, not because it's mocked.
