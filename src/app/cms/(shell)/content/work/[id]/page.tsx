...
import { StatusStepper } from '@/components/cms/collection/StatusStepper';
...
import { transitionWorkStatusAction } from '@/lib/cms/actions/work';
import { canUnpublishOverride, getAvailableTransitions } from '@/lib/cms/workflow-permissions';
  ...
  return (
    <div className="flex flex-col gap-8">
      <PageHeader
        ...
        actions={
          canEdit ? (
            <ButtonLink href={`/cms/content/work/${id}/edit`} variant="secondary">
              Edit
            </ButtonLink>
          ) : undefined
        }
