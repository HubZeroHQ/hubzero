...
export const metadata: Metadata = { title: 'Blueprints editorial order — HubZero Studio' };
 ...
 */
export default function BlueprintsFeaturedOrderRoute() {
  return <FeaturedOrderPage collection={FEATURED_COLLECTIONS.blueprints} />;
}
