...
export const metadata: Metadata = { title: 'Notes editorial order — HubZero Studio' };
 ...
 */
export default function NotesFeaturedOrderRoute() {
  return <FeaturedOrderPage collection={FEATURED_COLLECTIONS.notes} />;
}
