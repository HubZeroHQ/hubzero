...
export const metadata: Metadata = { title: 'Labs editorial order — HubZero Studio' };
 ...
 */
export default function LabsFeaturedOrderRoute() {
  return <FeaturedOrderPage collection={FEATURED_COLLECTIONS.labs} />;
}
