...
export const metadata: Metadata = { title: 'Builds editorial order — HubZero Studio' };
 ...
 */
export default function BuildsFeaturedOrderRoute() {
  return <FeaturedOrderPage collection={FEATURED_COLLECTIONS.builds} />;
}
