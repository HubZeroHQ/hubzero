    ...
    <form action={formAction} className="flex max-w-2xl flex-col gap-6">
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        <Field label="Location" name="location" error={state.fieldErrors?.location}>
          <Input id="location" name="location" defaultValue={initialValues?.location} required />
        </Field>
        <Field
      ...
      >
        <Input id="compensation" name="compensation" defaultValue={initialValues?.compensation} />
      </Field>
