...
import { CommandPalette } from '@/components/cms/command-palette/CommandPalette';
import { getBreadcrumbItems, getVisibleNav } from '@/lib/cms/navigation';
import { useKeyboardShortcuts } from '@/lib/cms/use-keyboard-shortcuts';
import type { UserRole } from '@/types/cms';
import { MobileNavDrawer } from './MobileNavDrawer';
import { Sidebar } from './Sidebar';
import { TopBar } from './TopBar';

const SIDEBAR_COLLAPSED_STORAGE_KEY = 'hubzero-cms-sidebar-collapsed';
...
/**
 * The application shell every future CMS screen renders inside
 ...
 * down as a prop — `CmsNavEntry` carries `lucide-react` icon component
 ...
 */
export function CmsShell({ role, hasAssignedLeads, user, children }: CmsShellProps) {
