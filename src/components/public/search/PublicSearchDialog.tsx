...
export function PublicSearchDialog() {
  ...
  return (
    <>
      ...
      >
        <div className="public-search-dialog-surface">
          ...
          >
            {!query.trim() ? (
              <div className="public-search-dialog-state">
                <p>
                  Search titles, summaries, references, technologies, authors, and relationships.
                </p>
              ...
              <p className="public-search-dialog-status">No published records match “{query}”.</p>
            ) : (
