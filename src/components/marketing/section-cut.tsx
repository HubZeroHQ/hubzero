 ...
 * opacity, no draw-in.
 *
 * Ice Blue, not Brand Blue — this is the technical-drawing register
 * (11_COLOR_PHILOSOPHY_AMENDMENT.md §6), never an interactive affordance.
 *
  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{
          backgroundImage: [
            "repeating-linear-gradient(45deg, color-mix(in oklch, var(--color-ice-blue) 30%, transparent) 0 1px, transparent 1px 12px)",
            "repeating-linear-gradient(-45deg, color-mix(in oklch, var(--color-ice-blue) 30%, transparent) 0 1px, transparent 1px 12px)",
          ].join(", "),
        }}
      />
