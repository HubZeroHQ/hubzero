...
HubZero products are not prototypes.
...
Implementation should reinforce the product's established design direction.

Avoid introducing components, layouts, interactions, or visual decisions that conflict with the product's intended personality.

When uncertain, prioritize consistency over experimentation.

---

# Preserve the Discoverability Strategy

Implementation should reinforce the product's selected discoverability strategy, where one applies.
...
Avoid implementation decisions that unintentionally weaken it.
...
Components, layouts, interactions, spacing, and content structure should remain consistent with the rest of the product.
