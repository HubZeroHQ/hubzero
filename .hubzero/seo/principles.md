...
Different product surfaces require different optimization strategies.

For example:

- Marketing sites emphasize expertise, trust, and conversion intent.
- Documentation and knowledge bases emphasize task completion and long-tail, question-shaped queries.
- Developer documentation emphasizes precise technical vocabulary and discoverability by the tools developers actually search from.
- Product launch pages emphasize timeliness and a single, unambiguous narrative.

General principles remain constant, while implementation adapts to the needs of each surface. See the category-specific documents in this directory: `marketing-sites.md`, `documentation.md`, `product-launches.md`, `developer-documentation.md`, `landing-pages.md`, `knowledge-bases.md`, and `product-discoverability.md`.
